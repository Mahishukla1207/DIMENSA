...
function numOfConnections(node) { 
...
function check_delta() { 
    ...
    for (let i = 0; i < config_nodes.length; i++) {
        ...
        if (numOfConnections(config_nodes[i]) == 2) { 
        ...
        else if (numOfConnections(config_nodes[i]) == 3) { 
    ...
    for (let i = 0; i < out_nodes.length; i++) { 
...
function check_star() { 
    ...
    if ((MyCounter == 0) && (in_nodes.length == 3) && (out_nodes.length == 3)) { 
        let indexes = [1, 2, 4]
...
MCB.onclick = function toggle_MCB() {
    ...
    if (MCB_state == 1) {
        ...
        document.getElementById('R-lamp').src = 'images/r-off.png'
        document.getElementById('Y-lamp').src= 'images/y-off.png'
        document.getElementById('B-lamp').src = 'images/b-off.png'
        ...
        document.getElementById('R-lamp').src = 'images/r-on.png'
        document.getElementById('Y-lamp').src=  'images/y-on.png'
        document.getElementById('B-lamp').src= 'images/b-on.png'
