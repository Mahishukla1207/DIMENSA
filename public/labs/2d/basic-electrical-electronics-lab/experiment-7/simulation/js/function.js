...
MCB.onclick = function togglemcb() {
    if (mcb_disabled == false) {
        if (mcb_state == 0) {
            ...
            this.src = "images/mcb-off.png"
            mcb_state = 0;
            var_disabled = 1;
            Var.src = "images/variac-off.png"
        }
    }
}
    ...
    if (var_disabled == 0) {
        if (var_state == 0) {
           ...
           Var.style.pointerEvents='none';
            ...
            this.src = "images/variac-off.png";
            var_state = 0;
...
function toggleS1(num) {
    if (num == 0) {
        swit1.src = 'images/switch-off.png'
        Load1.src = 'images/r-off.png'
    }
    else if (num == 1) {
        swit1.src = 'images/switch-on.png'
        Load1.src = 'images/r-on.png'
    }
}
...
function toggleS2(num) {
    ...
    if (num == 0) {
        ...
        swit2.src = 'images/switch-off.png'
        Load2.src = 'images/y-off.png'
    }

    else if (num == 1) {

        swit2.src = 'images/switch-on.png'
        Load2.src = 'images/y-on.png'
    }
...
function toggleS3(num) {
    if (num == 0) {
        swit3.src = 'images/switch-off.png'
        Load3.src = 'images/b-off.png'
    }
    else if (num == 1) {
        swit3.src = 'images/switch-on.png'
        Load3.src = 'images/b-on.png'
    }
}
