...
mcb_switch.onclick = function toggle_mcb() {
    ...
    if (mcb_state == 0) {
        ...
        document.getElementById('MCB').src = 'images/mcb-on.png'; 
        mcb_state = 1;
        ...
        onOff_switch.onclick = function toggle_switch() {
            ...
            if (onOff_state == 0) {
                ...
                document.getElementById('switch').src = 'images/switch-on.png'; 
                onOff_state = 1;
                add.disabled=0;
               ...
               onOff_switch.style.pointerEvents='auto';
                ...
                document.getElementById('switch').src = 'images/switch-off.png'; 
                onOff_state = 0;
                toggle_load_off();
                setZero();
                add.disabled=1;
        ...
        document.getElementById('MCB').src = 'images/mcb-off.png' 
        document.getElementById('Var').src = 'images/variac-off.png';
        var_voltage = 0;
        var_voltage = 0;
        mcb_state = 0;
    ...
    var_switch.onclick = function toggle_var() {
        ...
        if (mcb_state == 1) {
            ...
            if (var_state == 0) {
                ...
                document.getElementById('Var').src = 'images/variac-on.png'; 
                add.disabled = false;
                var_state = 1;
                add.disabled=1;
